      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          <div>
            <div className="flex items-center gap-4 mb-6">
              {LogoImage ? (
                <img src={LogoImage} alt="Wingy logo" className="w-10 h-10 object-contain" />
              ) : null}
              <h3 className="text-white text-2xl font-bold">Wingy</h3>
            </div>
            <p className="mb-6 leading-relaxed">
              Your favorite restaurants, delivered fast. Join thousands of satisfied customers enjoying quality food at their doorstep.
            </p>
            <div className="flex gap-4">
              ...
              >
                <Facebook size={20} className="text-white group-hover:text-[#fb923c] transition-colors" />
              </a>
              <a
                ...
                rel="noopener noreferrer"
              >
                <Youtube size={20} className="text-white group-hover:text-[#fb923c] transition-colors" />
              </a>
              <a
                ...
                rel="noopener noreferrer"
              >
                <Instagram size={20} className="text-white group-hover:text-[#fb923c] transition-colors" />
              </a>
              <a
                ...
                rel="noopener noreferrer"
              >
                <Linkedin size={20} className="text-white group-hover:text-[#fb923c] transition-colors" />
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="tel:+1234567890" className="hover:text-[#fb923c] transition-colors">
               +212 06 84 19 00 01
                </a>
              </li>
              <li className="flex items-center gap-3">
                <Mail className="text-[#fb923c] flex-shrink-0" size={20} />
                <a href="mailto:contact@wingy.ma" className="hover:text-[#fb923c] transition-colors">
                 contact@wingy.ma
                </a>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm">
              &copy; 2025 Wingy. All rights reserved.
            </p>
